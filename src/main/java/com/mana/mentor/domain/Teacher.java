...
public class Teacher implements Serializable {
    ...
    @ManyToOne
    private User modfier;

    @ManyToMany
    @JoinTable(
        name = "rel_teacher__subject",
    ...
    public Teacher dateCreated(Instant dateCreated) {
    ...
    public Teacher creator(User user) {
        this.setCreator(user);
        return this;
    }

    public User getModfier() {
        return this.modfier;
    }

    public void setModfier(User user) {
        this.modfier = user;
    }

    public Teacher modfier(User user) {
        this.setModfier(user);
        return this;
    }
